<!-- resumt -->
        <div class="panel panel-default">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                           <ul class="list-group">
                              <li class="list-group-item"><i class="fa fa-envelope"></i> {{ $userInstance->name }}</li>
                              <li class="list-group-item"><i class="fa fa-envelope"></i> {{ $userInstance->email }}</li>
                              <li class="list-group-item"><i class="fa fa-envelope"></i> {{ $userInstance->created_at }}</li>

                              @if( $userInstance->admin == 1 )

                              <li class="list-group-item"><i class="fa fa-envelope"></i> أدمين</li>
               ...
               <div class="bs-callout bs-callout-danger">
                  <h4>أخر تسع عقارات</h4>

                  @include('website.buildings.shareFile', compact('b4'))
               </div>
               <div class="bs-callout bs-callout-danger">
