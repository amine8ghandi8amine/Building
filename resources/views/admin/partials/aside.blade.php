      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> الإدارة الرئيسية للموقع
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> إدارة العقارت
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> إدارة الأعضاء
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> إدارة الرسائل
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                ...
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i> كافة الرسائل
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="#"><i class="fa fa-circle-o"> كافة الرسائل م.ج</i> 
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                      </a>
